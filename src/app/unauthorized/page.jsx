            ...
            <div className="max-w-md w-full text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    ...
                    <button
                        ...
                        className="inline-flex items-center justify-center gap-2 bg-gray-200 hover:bg-gray-300 text-gray-800 font-medium px-6 py-2.5 rounded-lg transition"
                    >
                ...
                <p className="mt-8 text-sm text-gray-400">
                    ...
                    <a href="mailto:support@hireloop.com" className="text-blue-600 hover:underline">
